...
const basePath = '/core-tech-1776325088871';
...
export default function Home() {
  ...
  const products = [{ n: 'Hosting', d: 'Our Hosting services provide secure, reliable, and high-performance hosting solutions for businesses and individuals, ensuring that their online presence is always available and accessible. With a range of plans to choose from, our hosting services are tailored to meet the unique needs of each client.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Web Dev', d: 'Our Web Dev services involve the design and development of custom websites that are visually appealing, user-friendly, and optimized for search engines. Our team of expert web developers work closely with clients to understand their unique needs and goals, delivering websites that effectively represent their brand and online presence.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'App Dev', d: 'Our App Dev services focus on the creation of bespoke mobile applications that meet the specific needs of our clients, whether it\'s for iOS, Android, or both. From conceptualization to deployment, our team of skilled app developers ensure that the final product is of the highest quality and provides a seamless user experience.', i: 'https://images.pexels.com/photos/20694602/pexels-photo-20694602.png?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain', d: 'Our Domain services provide clients with a simple and efficient way to register, manage, and maintain their domain names, ensuring that their online identity is protected and secure. With a range of domain extensions to choose from, our services cater to the diverse needs of businesses and individuals.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Inquiries', d: 'Our Inquiries service allows clients to get in touch with us regarding any questions, concerns, or feedback they may have about our services. Our dedicated team is always available to provide personalized support and guidance, ensuring that our clients receive the assistance they need in a timely and professional manner.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Core Tech, we specialize in providing innovative technology solutions to businesses and individuals in Kuching. With a strong focus on customer satisfaction, we strive to deliver high-quality services that meet the unique needs of our clients. Our team of experts is dedicated to staying at the forefront of the latest technological advancements, ensuring that our clients receive the best possible solutions.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To become the leading technology solutions provider in Kuching, known for our exceptional customer service, innovative approach, and commitment to excellence.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To provide tailored technology solutions that meet the evolving needs of our clients, while fostering a culture of innovation, customer satisfaction, and continuous improvement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">At Core Tech, our \'Customer First\' core value means that we prioritize the needs and satisfaction of our clients above all else, ensuring that their goals and objectives are met through our services.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">Our \'Innovation\' core value drives us to stay ahead of the curve in the technology industry, continuously seeking new and better ways to deliver cutting-edge solutions that exceed our clients\' expectations.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/19805885/pexels-photo-19805885.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/6804068/pexels-photo-6804068.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
